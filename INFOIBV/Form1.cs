...
namespace INFOIBV
{
    public partial class INFOIBV : Form
    {
        ...
        #region Assignment2
        /*
         * createStructuringElement creates a list containing ElementPoints, which are basically the relative x and y values to the origin and the value for the element
         * The shape takes three different chars, p for plus, s for square and c for circle. 
         * size should be at least 3 and has to be odd 
         */

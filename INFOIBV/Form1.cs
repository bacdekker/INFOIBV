...
namespace INFOIBV
{
    public partial class INFOIBV : Form
    {
        ...
        private void applyButton_Click(object sender, EventArgs e)
        {
            ...
            //The pipeline as described in the                                                    
            ...
            List<Point> corners = harrisCorner(workingImage, 4, 5000, createGaussianFilterDouble(7, 5f));
            workingImage = detectTriangles(workingImage, corners, false);
        ...
        //All methods for assignment 4 are in assignment4.cs. Below is unused code.
        #region Legacy
